...
public class SocketConst {
    ...
    //地址
    public static String CHAT_DEAULT_BASE="http://111.8.3.115:81";
    public static String CHAT_SOCKET_URL="";
    public static final String Socket_URL=CHAT_DEAULT_BASE+"/BSCTelmed/";//retrofit地址
    public static final String CHAT_PIC_URL=CHAT_DEAULT_BASE+"/BSCTelmed";//图片地址
    public static final String CHAT_COMMUNICATE_ADDRESS=CHAT_DEAULT_BASE;//视频聊天室地址
    public static final String DEAULT_URL=CHAT_DEAULT_BASE+"/BSCTelmed";//项目地址
